...
public class RestaurantServiceImpl implements RestaurantService {
    ...
    public List<RestaurantDto> getAll() {
        ...
        restaurantRepository
                .findAll()
                .forEach(
                        restaurant -> restaurants.add(restaurantConverter.toDto(restaurant)));
        return restaurants;
    }
    ...
    @Override
    @Transactional
    public void addDishToRestaurant(long restaurantId, long dishId) {
        Restaurant restaurant = restaurantConverter.toEntity(getById(restaurantId));
        Dish dish = dishConverter.toEntity(dishService.getById(dishId));
        restaurant.addDishToRestaurant(dish);
        update(restaurantId, restaurantConverter.toDto(restaurant));
    }
    ...
    public void deleteDishFromRestaurant(long restaurantId, long dishId) {
        Restaurant restaurant = restaurantConverter.toEntity(getById(restaurantId));
        Dish dish = dishConverter.toEntity(dishService.getById(dishId));
        restaurant.deleteDishFromRestaurant(dish);
        update(restaurantId, restaurantConverter.toDto(restaurant));
    }
}
